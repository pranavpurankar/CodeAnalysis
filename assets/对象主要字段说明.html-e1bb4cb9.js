import{_ as e,o as i,c as n,e as s}from"./app-abd48091.js";const a={},d=s(`<h1 id="对象主要字段说明" tabindex="-1"><a class="header-anchor" href="#对象主要字段说明" aria-hidden="true">#</a> 对象主要字段说明</h1><p>注：以下字段用于参考，具体字段格式需要以具体接口返回为准</p><h2 id="团队-org" tabindex="-1"><a class="header-anchor" href="#团队-org" aria-hidden="true">#</a> 团队（org）：</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>org_sid: str，团队编号
name: str，团队名称

import{_ as s,r as d,o as a,c as v,a as n,b as e,d as l,e as r}from"./app-abd48091.js";const t={},c=r(`<h1 id="使用自建工具git库" tabindex="-1"><a class="header-anchor" href="#使用自建工具git库" aria-hidden="true">#</a> 使用自建工具git库</h1><h2 id="为什么要自建工具库" tabindex="-1"><a class="header-anchor" href="#为什么要自建工具库" aria-hidden="true">#</a> 为什么要自建工具库</h2><ul><li>Github 对lfs流量有控制导致部分工具拉不下来</li><li>Github 下载速度有差异，为保证拉取速度建议使用流畅的工具库</li></ul><h2 id="如何使用其他工具库" tabindex="-1"><a class="header-anchor" href="#如何使用其他工具库" aria-hidden="true">#</a> 如何使用其他工具库</h2><ol><li>工具相对应的仓库地址，环境变量全部存储在puppy-tools-config仓库中，可通过fork该仓库，修改指定的工具仓库</li><li>修改<code>client/config.ini</code>中的字段指定puppy-tools-config，如下</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[COMMON]
; [必填]工具配置库git地址

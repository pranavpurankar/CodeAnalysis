import{_ as t,o as e,c as d,e as i}from"./app-abd48091.js";const n={},s=i(`<h1 id="任务管理模块" tabindex="-1"><a class="header-anchor" href="#任务管理模块" aria-hidden="true">#</a> 任务管理模块</h1><h2 id="执行指定代码库指定分析项目扫描任务" tabindex="-1"><a class="header-anchor" href="#执行指定代码库指定分析项目扫描任务" aria-hidden="true">#</a> 执行指定代码库指定分析项目扫描任务</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>POST /server/main/api/orgs/&lt;org_sid&gt;/teams/&lt;team_name&gt;/repos/&lt;repo_id&gt;/projects/&lt;project_id&gt;/scans/create/

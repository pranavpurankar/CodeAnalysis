import{_ as s,r as a,o as d,c as n,a as e,b as r,d as l,e as c}from"./app-abd48091.js";const v={},t=c(`<h1 id="源码安装-redis" tabindex="-1"><a class="header-anchor" href="#源码安装-redis" aria-hidden="true">#</a> 源码安装 Redis</h1><h2 id="运行环境" tabindex="-1"><a class="header-anchor" href="#运行环境" aria-hidden="true">#</a> 运行环境</h2><ol><li>基于x86_64的CentOS</li><li>基于鲲鹏920（aarch64）的UOS V20</li><li>基于飞腾2000（aarch64）的TencentOS Server</li></ol><h2 id="环境准备" tabindex="-1"><a class="header-anchor" href="#环境准备" aria-hidden="true">#</a> 环境准备</h2><p>安装编译打包需要的工具</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum install -y gcc make tcl wget

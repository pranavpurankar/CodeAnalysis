import{_ as e,o as t,c as i,e as n}from"./app-abd48091.js";const d={},u=n(`<h1 id="项目管理模块" tabindex="-1"><a class="header-anchor" href="#项目管理模块" aria-hidden="true">#</a> 项目管理模块</h1><h2 id="查看指定代码库的指定分析项目列表" tabindex="-1"><a class="header-anchor" href="#查看指定代码库的指定分析项目列表" aria-hidden="true">#</a> 查看指定代码库的指定分析项目列表</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>GET /server/main/api/orgs/&lt;org_sid&gt;/teams/&lt;team_name&gt;/repos/

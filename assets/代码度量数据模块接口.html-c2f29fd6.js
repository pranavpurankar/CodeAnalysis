import{_ as t,o as e,c as i,e as n}from"./app-abd48091.js";const d={},u=n(`<h1 id="代码度量数据管理" tabindex="-1"><a class="header-anchor" href="#代码度量数据管理" aria-hidden="true">#</a> 代码度量数据管理</h1><h2 id="查看指定项目的圈复杂度文件列表" tabindex="-1"><a class="header-anchor" href="#查看指定项目的圈复杂度文件列表" aria-hidden="true">#</a> 查看指定项目的圈复杂度文件列表</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>GET /server/analysis/api/orgs/&lt;org_sid&gt;/teams/&lt;team_name&gt;/repos/&lt;repo_id&gt;/projects/&lt;project_id&gt;/codemetric/ccfiles/
